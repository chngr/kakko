...
for i = 1:length(basis)
    ...
    for j = 1:length(tuple_image)
        ...
        for k = 1:length(k_p_indices)
            if cur_mat(k_p_indices(k),tuple_diff(1)) == 1 && ...
                   cur_mat(k_p_indices(k),tuple_diff(2)) == 1 && ...
                   cur_mat(k_p_indices(k),tuple_diff(3)) == 1
               a = a + 1;
            elseif cur_mat(k_p_indices(k),tuple_diff(1)) == 1 && ...
                   cur_mat(k_p_indices(k),tuple_diff(2)) == 1 && ...
                   cur_mat(k_p_indices(k),tuple_diff(3)) == 0
               b = b + 1;
            elseif cur_mat(k_p_indices(k),tuple_diff(1)) == 1 && ...
                   cur_mat(k_p_indices(k),tuple_diff(2)) == 0 && ...
                   cur_mat(k_p_indices(k),tuple_diff(3)) == 1
               c = c + 1;
            elseif cur_mat(k_p_indices(k),tuple_diff(1)) == 1 && ...
                   cur_mat(k_p_indices(k),tuple_diff(2)) == 0 && ...
                   cur_mat(k_p_indices(k),tuple_diff(3)) == 0
               d = d + 1;
            elseif cur_mat(k_p_indices(k),tuple_diff(1)) == 0 && ...
                   cur_mat(k_p_indices(k),tuple_diff(2)) == 1 && ...
                   cur_mat(k_p_indices(k),tuple_diff(3)) == 1
               e = e + 1;
            elseif cur_mat(k_p_indices(k),tuple_diff(1)) == 0 && ...
