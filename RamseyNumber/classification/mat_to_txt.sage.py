...
# This file was *autogenerated* from the file mat_to_txt.sage
from sage.all_cmdline import *   # import sage library

_sage_const_2 = Integer(2); _sage_const_1 = Integer(1); _sage_const_0 = Integer(0)# def mat_to_txt(mat_set, name):
#     f = open(name, 'w')
#     f.write('[')
